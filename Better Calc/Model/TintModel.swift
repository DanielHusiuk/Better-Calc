...
struct TintModel {
    var tints: [tintStruct] = [
        tintStruct(id: 0,    text: "Better Orange",     color: #colorLiteral(red: 0.8163539171, green: 0.538916111, blue: 0.3300756216, alpha: 1),         image: UIImage(named: "AppIcon_small0.png")!),
        tintStruct(id: 1,    text: "System Orange",     color: #colorLiteral(red: 0.9960784314, green: 0.5333333333, blue: 0.137254902, alpha: 1),         image: UIImage(named: "AppIcon_small1.png")!),
        ...
        tintStruct(id: 7,    text: "Miami One",        color: #colorLiteral(red: 0.05098039216, green: 0.5019607843, blue: 0.6078431373, alpha: 1),         image: UIImage(named: "AppIcon_small7.png")!),
        tintStruct(id: 8,    text: "Just Gray",        color: #colorLiteral(red: 0.4039215686, green: 0.4039215686, blue: 0.4039215686, alpha: 1),         image: UIImage(named: "AppIcon_small8.png")!)
    ]
