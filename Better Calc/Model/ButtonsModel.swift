...
struct ButtonsModel {
    var buttons: [Button] = [
        ...
        Button(id: 13,   text: "Speed",         image: UIImage(named: "gauge.speed.svg")!,              segue: "SpeedSegue"),
        Button(id: 14,   text: "Mass",          image: UIImage(named: "scalemass.svg")!,                segue: "MassSegue"),
        Button(id: 15,   text: "Count System",   image: UIImage(named: "01.square.svg")!,                segue: "CountSegue"),
        Button(id: 16,   text: "Discount",       image: UIImage(named: "tag.svg")!,                     segue: "DiscountSegue"),
        Button(id: 17,   text: "Investition",    image: UIImage(named: "chart.line.svg")!,               segue: "InvestitionSegue"),
        Button(id: 18,   text: "Loan",          image: UIImage(named: "creditcard.svg")!,               segue: "LoanSegue"),
        Button(id: 19,   text: "Tips",          image: UIImage(named: "centsign.circle.svg")!,           segue: "TipsSegue"),
        Button(id: 20,   text: "BMI",           image: UIImage(named: "heart.text.square.svg")!,         segue: "BmiSegue"),
        Button(id: 21,   text: "Settings",       image: UIImage(named: "gear.svg")!,                    segue: "SettingsSegue")
    ]
