...
struct ButtonsModel {
    var buttons: [Button] = [
        ...
        Button( id: 6,      text: NSLocalizedString("button_area", comment: ""),            image: UIImage(named: "arrow.left.right.square.svg")!,   segue: "AreaSegue"),
        ...
        Button( id: 12,     text: NSLocalizedString("button_speed", comment: ""),           image: UIImage(named: "gauge.speed.svg")!,              segue: "SpeedSegue"),
        ...
        Button( id: 18,     text: NSLocalizedString("button_investition", comment: ""),      image: UIImage(named: "chart.line.svg")!,               segue: "InvestitionSegue"),
